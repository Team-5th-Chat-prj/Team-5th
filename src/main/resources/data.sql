...
INSERT IGNORE INTO members (id, email, password, nickname, profile_image_url, average_rating, review_count, role, deleted, created_at, updated_at) VALUES
                                                                                                                                                       (1, 'jjangu@test.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh9i', '짱구', NULL, 0.0, 0, 'USER', false, NOW(), NOW()),
                                                                                                                                                       (2, 'happy@test.com',  '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lh9i', '햅삐', NULL, 4.5, 3, 'USER', false, NOW(), NOW());
...
-- 거래중 거래 (상품5: 햅삐가 거래완료 가능)
                                                                                                                                           (2, 5, 1, 2, 'TRADING',  NOW(), NOW(), NULL, NOW(), NOW()),
-- 판매완료 거래 (상품6: 짱구가 리뷰 작성 가능)
...
INSERT IGNORE INTO chat_message (id, chat_room_id, sender_id, sender_nickname, content, is_read, created_at, updated_at) VALUES
                                                                                                                             (1, 1, 1, '짱구', '안녕하세요! 아직 판매 중인가요?', true,  NOW(), NOW()),
                                                                                                                             (2, 1, 2, '햅삐', '네, 판매 중입니다 :)',             true,  NOW(), NOW()),
                                                                                                                             (3, 1, 1, '짱구', '직거래 가능한가요?',               false, NOW(), NOW());

-- ─── 추가 더미 데이터 (짱구 id:1 / 햅삐 id:2) ──────────
-- 짱구 판매 상품
INSERT IGNORE INTO product (id, seller_id, category_id, title, description, price, status, like_count, is_deleted, created_at, updated_at) VALUES
                                                                                                                                               (200, 1, 1, '맥북 프로 14인치 M3', '2023년 구매, 스크래치 없음. 충전기 포함.', 1800000, 'SALE', 12, false, NOW(), NOW()),
                                                                                                                                               (201, 1, 1, '에어팟 프로 2세대', '6개월 사용, 케이스 포함. 배터리 95%.', 180000, 'SALE', 7, false, NOW(), NOW()),
                                                                                                                                               (202, 1, 4, '무신사 스탠다드 후드티 XL', '한 번 세탁, 상태 좋음. 블랙 컬러.', 28000, 'SALE', 3, false, NOW(), NOW()),
                                                                                                                                               (203, 1, 6, '나이키 에어맥스 270 270mm', '3회 착용, 박스 있음. 거의 새것.', 95000, 'SALE', 9, false, NOW(), NOW()),
                                                                                                                                               (204, 1, 5, '토익 LC RC 최신판 세트', '2024년판, 필기 없음. 직거래 선호.', 22000, 'SALE', 2, false, NOW(), NOW()),
                                                                                                                                               (205, 1, 3, '허먼밀러 의자 에어론', '3년 사용, 허리 지지대 정상. 직거래만.', 650000, 'SALE', 15, false, NOW(), NOW()),
                                                                                                                                               (206, 1, 2, '다이슨 에어랩 완전체', '1년 사용, 모든 어태치먼트 포함.', 420000, 'SALE', 11, false, NOW(), NOW()),

-- 햅삐 판매 상품
                                                                                                                                               (210, 2, 1, '갤럭시 S24 울트라 256GB', '3개월 사용, 케이스+필름 부착. 티타늄 블랙.', 950000, 'SALE', 8, false, NOW(), NOW()),
                                                                                                                                               (211, 2, 1, '아이패드 에어 5세대 WiFi', '1년 사용, 애플펜슬 2세대 포함.', 480000, 'SALE', 6, false, NOW(), NOW()),
                                                                                                                                               (212, 2, 4, '아디다스 트레이닝복 세트 M', '2회 착용, 상하의 세트. 네이비 컬러.', 45000, 'SALE', 4, false, NOW(), NOW()),
                                                                                                                                               (213, 2, 6, '요가매트 + 필라테스 소품 세트', '6개월 사용, 세척 완료. 보관 상태 좋음.', 35000, 'SALE', 5, false, NOW(), NOW()),
                                                                                                                                               (214, 2, 3, '이케아 KALLAX 책장 4x4', '2년 사용, 조립 상태 양호. 직거래만.', 55000, 'SALE', 3, false, NOW(), NOW()),
                                                                                                                                               (215, 2, 5, '파이썬 프로그래밍 책 3권 세트', '밑줄 없음, 깨끗한 상태.', 18000, 'SALE', 1, false, NOW(), NOW()),
                                                                                                                                               (216, 2, 2, '쿠쿠 전기밥솥 6인용', '1년 사용, 정상 작동. 박스 없음.', 65000, 'SALE', 7, false, NOW(), NOW());
